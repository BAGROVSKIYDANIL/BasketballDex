...
const AddTeam = () => {
    return (
        <div className="addTeam">
            <div className="addTeam__menu">
                <div className="addTeam__path">
                    <a href="#/">Teams</a>
                    <span>/</span>
            ...
            <div className="addTeam__wrapper">
                ...
                <div className="form">
                    <form action="" className="form__wrapper">
                        ...
                        <div className="form__group">
                            <label className="form__label" htmlFor="">Division</label>
                            <input className='form__input' type="text" />
                        </div>
                        <div className="form__group">
                            <label className="form__label" htmlFor="">Conference</label>
                            <input className='form__input' type="text" />
                        </div>
                        <div className="form__group">
                            <label className="form__label" htmlFor="">Year of foundation</label>
                            <input className='form__input' type="text" />
                        </div>
